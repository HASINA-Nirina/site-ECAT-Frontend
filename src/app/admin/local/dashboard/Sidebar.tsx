      ...
      >
        ...
        >
            ...
            return (
              <Link key={item.name} href={item.href} prefetch>
                <div className="relative w-full">
                  ...
                  <div
                    className={`
                      relative flex items-center gap-2 px-1 py-3 rounded-lg cursor-pointer transition-colors duration-300 z-10
          ...
          <button
            ...
            className="mt-auto flex items-center gap-2 px-3 py-2 rounded-lg bg-[#17f] hover:bg-blue-600 transition-colors w-full text-left"
          >
