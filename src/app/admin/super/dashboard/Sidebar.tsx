...
export default function Sidebar({ darkMode, sidebarOpen, setSidebarOpen }: SidebarProps) {
  ...
  const menuItems = [
    { name: "Tableau de bord", icon: <LayoutDashboard size={20} />, href: "/admin/super/dashboard" },
    { name: "Admin locaux", icon: <UsersIcon size={20} />, href: "/admin/super/AdminLocal" },
    { name: "Liste étudiants", icon: <Users size={20} />, href: "/admin/super/etudiants" },
    { name: "Gerer formations", icon: <ClipboardList size={20} />, href: "/admin/super/formation" },
    { name: "Liste Paiements", icon: <CreditCard size={20} />, href: "/admin/super/paiements" },
    { name: "Historiques", icon: <List size={20} />, href: "/admin/super/rapports" },
    { name: "Paramètre compte", icon: <Settings size={20} />, href: "/admin/super/SettingCompte" },
  ];
  ...
  return (
    ...
    <aside className={`w-64 h-full flex flex-col gap-4 relative`}>
      ...
      <div
        className={`p-12 rounded-lg shadow-md w-full h-full flex flex-col gap-4 ${
          darkMode ? "bg-gray-900" : "bg-white"
        }`}
      >
        {menuItems.map((item) => {
